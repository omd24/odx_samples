...
// NOTE(omid): Description of resources in SquidRoom.bin

//
// Reference: 
// https://github.com/microsoft/DirectX-Graphics-Samples/blob/master/Samples/Desktop/D3D12Multithreading/src/SquidRoom.h
//

namespace SampleAssets {
wchar_t const DataFilename [] = L"SquidRoom.bin";

D3D12_INPUT_ELEMENT_DESC const StandardVertexDescription [] = {
...
UINT const StandardVertexStride = 44;

DXGI_FORMAT const StandardIndexFormat = DXGI_FORMAT_R32_UINT;
...
UINT const VertexDataOffset = 30'277'640;
UINT const VertexDataSize = 9'685'808;
UINT const IndexDataOffset = 39'963'448;
UINT const IndexDataSize = 3'056'844;

TextureResource const Textures [] = {
    {   512,   512,   1,       DXGI_FORMAT_BC1_UNORM, { {0, 131'072, 1'024},} }, // squard room platform_3_diff_512.dds
